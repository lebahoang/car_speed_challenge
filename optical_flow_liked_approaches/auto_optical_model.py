...
def stack_2_frames(frame_prev, frame_current):
    return np.concatenate((frame_prev, frame_current), axis=2)

class AutoOpticalModel():
    def __init__(self, input_shape,
        ...
        with tf.device(device):
            ...
            h,w,c = input_shape
            self.inputs = tf.placeholder(tf.float32, [None, h,w,2*c], name="inputs")
            # follow nvidia model
